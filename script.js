...
/********* calculation for building homepage  footprint******/


/*function getselectMonth(){
    document.getElementById('lblmess').innerHTML=
    ("Month: <b style='color.red;'>" 
    +formmonth.ddlmonths[formmonth.ddlmonths.selectedIndex].text+'</b>')
}

function getselectYear(){
    document.getElementById('lblmess2').innerHTML=
    ("Welcome to Green planet , we will calculate C02 emission for your busniess for you: <b style='color.red;'>" 
    +formmonth.ddlmonths[formmonth.ddlmonths.selectedIndex].text+ " , "
    +formyear.ddlyears[formyear.ddlyears.selectedIndex].text+ " for you" + '</b>')
}
/*
function car_info(){
    var a=document.getElementById('input').Value;
    if(a==='usdatabase'){
        var array=['1999','2000','2001'];
    }
    else if(a==='avevan'){
        var array=['1999','2000','2001'];
    }
    else if(a==='Ukdatabase'){
        var array=['1999','2000','2001'];
    }
    else {
